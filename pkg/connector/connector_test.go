...
func TestPrepareConnectionString(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			cliOutputs: map[string]string{
				"ceph auth get-key client.test":                    "AQAcpuJiITYXMhAAXaOoAqOKJ4mhNOAqxFb1Hw==",
			...
			expectedInfoStr: string(unitinputs.ExternalConnectionSecretNonAdmin.Data["connection"]),
		},
		{
