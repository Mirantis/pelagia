...
| `lcmConfig.useIngress` | Deprecated. Enable support for Ingress usage. Will be removed in the following release due to [NGINX Ingress retirement](https://kubernetes.io/blog/2025/11/11/ingress-nginx-retirement/). | `true` |
