...
- `auxilaryService` - Optional. Enables the current Ceph RGW instance to operate without a `StorageClass`
...
- `usedByIngress` - Optional. Enables the current Ceph RGW instance to be used by the Ingress controller.
